...
public class DEIException extends RuntimeException {
	...
	public DEIException(ErrorMessage errorMessage, Object... args) {
		super(String.format(errorMessage.getLabel(), args));
		logger.error(String.format(errorMessage.getLabel(), args));
		this.errorMessage = errorMessage;
	}
